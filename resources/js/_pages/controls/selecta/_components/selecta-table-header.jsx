...
import { setFilteredSelecta } from "../../_redux/controls-slice";
import SelectaCreateForm from "./selecta-create-form";
export default function SelectaTableHeader() {
    const [query, setQuery] = useState("");

    const { selecta } = useSelector((state) => state.controls);
    ...
    useEffect(() => {
        dispatch(setFilteredSelecta(filtered));
    }, [query]);

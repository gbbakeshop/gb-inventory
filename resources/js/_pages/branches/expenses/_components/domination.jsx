...
import { create_domination, get_domination } from "@/_services/domination-services";

import moment from "moment";
import React, { useEffect, useState } from "react";
import { useDispatch, useSelector } from "react-redux";

export default function Domination({branch_id}) {
    ...
    function submitDomination() {
        setLoading(true);
        dispatch(setToastStatus(loadingState()));
        create_domination({
            branchid: branch_id,

export default function ExpensesDataCard({data}) {
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="md:col-span-2 lg:col-span-1" >
              <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                  <svg className="w-40 m-auto " viewBox="0 0 146 146" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                      <h5 className="text-xl text-gray-600 text-center">Todays Record</h5>
                      <div className="mt-2 flex justify-center gap-4">
                          <h3 className="text-3xl font-bold text-gray-700">₱ {data?.br??'0.00'}</h3>
                      </div>
                  </div>
                  <table className="w-full text-gray-600">
                      <tbody>
                          <tr>
                              <td className="py-2">Bread Sales</td>
                              <td className="text-gray-500">₱ {data?.br??'0.00'}</td>
                              <td>
                          ...
                          <tr>
                              <td className="py-2">Selecta Sales</td>
          ...
          <div>
              <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                  <svg className="mt-8 w-full" viewBox="0 0 218 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="mt-12">
                      <h5 className="text-xl text-gray-600 text-center">Deductions</h5>
                      <div className="mt-2 flex justify-center gap-4">
          ...
          <div>
              <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                  ...
                  <div className="mt-6">
                      <h5 className="text-xl text-gray-600 text-center">Actual Amount</h5>
                      <div className="mt-2 flex justify-center gap-4">
                          <h3 className="text-3xl font-bold text-gray-700">₱ 23,988</h3>
                      </div>
                  </div>
                  <table className="mt-6 -mb-2 w-full text-gray-600">
                      <tbody>
                          <tr>
                              <td className="py-2">Todays Record</td>
                              <td className="text-gray-500">896</td>
                              <td>
                                  <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
